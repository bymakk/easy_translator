...
<img src="https://raw.githubusercontent.com/bymakk/easy_translator/main/docs/readme-preview-0.0.143.webp" alt="Easy Translator — окно перевода (v0.0.143)" width="1002" />
...
- **Замена текста в полях ввода** — маленький попап переводит и вставляет перевод прямо в поле (в т.ч. чат Twitch и другие редакторы на Slate.js)
...
Установите из **[Интернет-магазина Chrome](https://chromewebstore.google.com/detail/easy-translator/fbddhfelomllajcpdeajomdcaamniojf)** — обновления приходят автоматически.

### Сборка с GitHub (ZIP)

Готовый билд — на странице **[Releases](https://github.com/bymakk/easy_translator/releases/latest)** или в папке [`release/`](./release/) репозитория: файл `easy_translator_vX.X.XX.zip`. В архиве `manifest.json` лежит в корне — можно установить перетаскиванием. Дальше на выбор любой из двух способов.
...
### Перевод в чате Twitch уходит на русском

Обновитесь до **v0.0.224** или новее. В старых версиях Slate-редактор Twitch показывал перевод визуально, но отправлял оригинал — в 0.0.224 это исправлено. Для применения перевода в чате используйте кнопку в inline-панели или **Cmd/Ctrl+Enter** (обычный Enter отправляет сообщение).
