...
| | Результат |
|---|---|
| 🔵 Google | Сломай ногу сегодня на презентации! |
...
| | Результат |
|---|---|
| 🔵 Google | без кепки, этот наряд идет тяжело |
| 🟣 Grok | без шуток, этот наряд просто бомба |
...
| | Результат |
|---|---|
| 🔵 Google | Он бросил меня под автобус на глазах у всей команды |
| 🟣 Grok | Он подставил меня перед всей командой |
...
| | Результат |
|---|---|
| 🔵 Google | Не призраки меня после этого, ладно? |
| 🟣 Grok | Только не пропадай после этого, ладно? |
...
| | Результат |
|---|---|
| 🔵 Google | Эта шутка пришлась так хорошо, что он ее там наверху убил |
| 🟣 Grok | Шутка зашла отлично — он просто порвал зал |
