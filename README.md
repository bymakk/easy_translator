...
### Сравнение: Google, Yandex и Grok

Ниже — **реальные** ответы публичных API Google и Yandex (запрос `en → ru`, тот же текст). Ответы **Grok** — с подключённой моделью в расширении; формулировка может слегка отличаться по версии модели.

Разница особенно заметна на идиомах, сленге и разговорных выражениях.
...
| | Google | Yandex | Grok |
|---|---|---|---|
| Результат | Сломай ногу сегодня на презентации! | Ни с того ни с сего приходите на свою сегодняшнюю презентацию! | Ни пуха ни пера на презентации сегодня! |
...
| | Google | Yandex | Grok |
|---|---|---|---|
| Результат | без кепки, этот наряд идет тяжело | без кепки этот наряд будет очень к лицу. | без шуток, этот наряд просто бомба |

---

**Разговорная идиома**

> *"He threw me under the bus in front of the whole team"*

| | Google | Yandex | Grok |
|---|---|---|---|
| Результат | Он бросил меня под автобус на глазах у всей команды | Он выставил меня напоказ на глазах у всей команды | Он подставил меня перед всей командой |

---

**Интернет-сленг**

> *"Don't ghost me after this, okay?"*

| | Google | Yandex | Grok |
|---|---|---|---|
| Результат | Не призраки меня после этого, ладно? | Не приходи ко мне после этого, ладно? | Только не пропадай после этого, ладно? |

---

**Переносное значение**

> *"That joke landed so well, he killed it up there"*

| | Google | Yandex | Grok |
|---|---|---|---|
| Результат | Эта шутка пришлась так хорошо, что он ее там наверху убил | Эта шутка так хорошо удалась, что он просто взорвал ее | Шутка зашла отлично — он просто порвал зал |
